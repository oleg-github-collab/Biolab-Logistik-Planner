...
export const PERMISSIONS = {
  ...
  'schedule:read': [ROLES.USER, ROLES.EMPLOYEE, ROLES.ADMIN, ROLES.SUPERADMIN, ROLES.OBSERVER],
  ...
  // Message permissions
  'message:read': [ROLES.USER, ROLES.EMPLOYEE, ROLES.ADMIN, ROLES.SUPERADMIN, ROLES.OBSERVER],
  'message:send': [ROLES.USER, ROLES.EMPLOYEE, ROLES.ADMIN, ROLES.SUPERADMIN, ROLES.OBSERVER],
  'message:delete': [ROLES.ADMIN, ROLES.SUPERADMIN],

  // Waste management permissions
  'waste:read': [ROLES.EMPLOYEE, ROLES.ADMIN, ROLES.SUPERADMIN, ROLES.OBSERVER],
  ...
  // Task permissions
  'task:read': [ROLES.USER, ROLES.EMPLOYEE, ROLES.ADMIN, ROLES.SUPERADMIN, ROLES.OBSERVER],
