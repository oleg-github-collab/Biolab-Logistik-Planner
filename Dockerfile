# Use Node.js 18 LTS - v13.1.1 MOBILE UI POLISH
FROM node:18-alpine

# NUCLEAR CACHE BUST - v13.1.1 - UI FIXES
ARG BUILDTIME_CACHEBUST=1769735700
RUN echo "✅ v13.1.1 MOBILE UI POLISH - CACHE BUSTER: $BUILDTIME_CACHEBUST ✅"
