# Use Node.js 18 LTS - v13.8.0 PERFECT CALENDAR + CONTACTS FIX
FROM node:18-alpine

# NUCLEAR CACHE BUST - v13.8.0 - DESKTOP CONTACTS & MOBILE CALENDAR PERFECTION
ARG BUILDTIME_CACHEBUST=1769745000
RUN echo "🎨 v13.8.0 PERFECT DESIGN & NO JUMPING - CACHE BUSTER: $BUILDTIME_CACHEBUST 🎨"
