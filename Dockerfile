# Use Node.js 18 LTS - v13.5.0 MAJOR FIXES
FROM node:18-alpine

# NUCLEAR CACHE BUST - v13.5.0 - CONTACTS & CALENDAR FIXES
ARG BUILDTIME_CACHEBUST=1769741000
RUN echo "⚡ v13.5.0 PERFORMANCE & MULTI-DAY EVENTS - CACHE BUSTER: $BUILDTIME_CACHEBUST ⚡"
