# Use Node.js 18 LTS - v13.6.0 MOBILE CALENDAR REDESIGN
FROM node:18-alpine

# NUCLEAR CACHE BUST - v13.6.0 - MOBILE CALENDAR LIKE DESKTOP
ARG BUILDTIME_CACHEBUST=1769742500
RUN echo "📱 v13.6.0 MOBILE CALENDAR FULL REDESIGN - CACHE BUSTER: $BUILDTIME_CACHEBUST 📱"
