# Use Node.js 18 LTS - v13.4.0 MOBILE DESIGN POLISH
FROM node:18-alpine

# NUCLEAR CACHE BUST - v13.4.0 - DESIGN IMPROVEMENTS
ARG BUILDTIME_CACHEBUST=1769739200
RUN echo "✨ v13.4.0 MOBILE DESIGN POLISH - CACHE BUSTER: $BUILDTIME_CACHEBUST ✨"
