# Use Node.js 18 LTS - v13.3.0 MODAL FIX
FROM node:18-alpine

# NUCLEAR CACHE BUST - v13.3.0 - MODAL RENDERING FIX
ARG BUILDTIME_CACHEBUST=1769738400
RUN echo "✅ v13.3.0 MODAL RENDERING FIX - CACHE BUSTER: $BUILDTIME_CACHEBUST ✅"
