# Use Node.js 18 LTS - v13.1 MOBILE COMPLETE FIX
FROM node:18-alpine

# NUCLEAR CACHE BUST - v13.1.0 - PRODUCTION FIX
ARG BUILDTIME_CACHEBUST=1769734800
RUN echo "✅ v13.1.0 MOBILE COMPLETE FIX - CACHE BUSTER: $BUILDTIME_CACHEBUST ✅"
