# Use Node.js 18 LTS - v13.5.1 SCROLL POSITION FIX
FROM node:18-alpine

# NUCLEAR CACHE BUST - v13.5.1 - PRESERVE SCROLL ON CONTACT SELECT
ARG BUILDTIME_CACHEBUST=1769741500
RUN echo "🔧 v13.5.1 SCROLL POSITION PRESERVED - CACHE BUSTER: $BUILDTIME_CACHEBUST 🔧"
