# Use Node.js 18 LTS - v13.12.1 SAVEPOINT FIX
FROM node:18-alpine

# NUCLEAR CACHE BUST - v13.12.1 - SAVEPOINTS FOR TRANSACTION SAFETY
ARG BUILDTIME_CACHEBUST=1770154642
RUN echo "🔧 v13.12.1 SAVEPOINT FIX - CACHE BUSTER: $BUILDTIME_CACHEBUST 🔧"
