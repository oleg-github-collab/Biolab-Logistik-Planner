# Use Node.js 18 LTS - v13.4.1 ONLINE STATUS FIX
FROM node:18-alpine

# NUCLEAR CACHE BUST - v13.4.1 - REMOVE GROUP ONLINE STATUS
ARG BUILDTIME_CACHEBUST=1769739600
RUN echo "🔧 v13.4.1 GROUP ONLINE STATUS FIX - CACHE BUSTER: $BUILDTIME_CACHEBUST 🔧"
