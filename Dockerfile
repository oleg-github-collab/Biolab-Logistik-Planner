# Use Node.js 18 LTS - v13.7.0 MOBILE MULTI-DAY EVENTS FIX
FROM node:18-alpine

# NUCLEAR CACHE BUST - v13.7.0 - MOBILE CALENDAR MULTI-DAY WORKING
ARG BUILDTIME_CACHEBUST=1769743500
RUN echo "✅ v13.7.0 MOBILE MULTI-DAY EVENTS FIXED - CACHE BUSTER: $BUILDTIME_CACHEBUST ✅"
