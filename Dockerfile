# Use Node.js 18 LTS - v13.2.0 MOBILE CRITICAL FIXES
FROM node:18-alpine

# NUCLEAR CACHE BUST - v13.2.0 - CRITICAL FIXES
ARG BUILDTIME_CACHEBUST=1769736600
RUN echo "✅ v13.2.0 MOBILE CRITICAL FIXES - CACHE BUSTER: $BUILDTIME_CACHEBUST ✅"
