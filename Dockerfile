# Use Node.js 18 LTS - v13.4.2 STORY COMPOSER FIX
FROM node:18-alpine

# NUCLEAR CACHE BUST - v13.4.2 - CAMERA & BUTTONS FIX
ARG BUILDTIME_CACHEBUST=1769740000
RUN echo "📸 v13.4.2 STORY COMPOSER CAMERA FIX - CACHE BUSTER: $BUILDTIME_CACHEBUST 📸"
